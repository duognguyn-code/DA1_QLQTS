...
public class KhuyenMaiRespositoryimpl implements KhuyenMaiRespository{
    ...
    public ArrayList<KhuyenMai> getListKhuyenMaiDB() {
        ...
        try (java.sql.Connection con = connection.getConnection(); PreparedStatement ps = con.prepareStatement(query)) {
    ...
    public Boolean themKhuyenMai(KhuyenMai km) {
       int checkThem = 0;
        ...
        try (java.sql.Connection con = DBConnection.getConnection(); PreparedStatement ps = con.prepareStatement(query)) {
