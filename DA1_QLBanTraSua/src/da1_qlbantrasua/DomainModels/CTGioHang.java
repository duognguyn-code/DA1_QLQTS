...
public class CTGioHang {
    ...
    public CTGioHang(String id, String maHoaDon, String idSanPham, String tenSanPham, int soLuongSP, double dongGia, double tongTien, String idDuong, String tenDuong, String idDa, String tenDa, String idTopping, String tenTopping, int trangThai) {
        this.id = id;
